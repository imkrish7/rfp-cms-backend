...
import { objectURL, presignedURL } from "../services/uploadService";
...
export const getAllRFPController = async (req: Request, res: Response) => {
    try {
        const orgId = req.user?.orgId;
...
export const getRFPByIdController = async (req: Request, res: Response) => {
    try {
...
export const getRFPAttachmentPresignsController =  async (req: Request, res: Response) => {
    try {
...
export const rfpAttachmentsStatusUpdateController =  async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
        if (!id) {
            return res.status(StatusCodes.FORBIDDEN).json({error: "Invalid request"})
...
export const rfpSubmitController = async (req: Request, res: Response) => {
	try {
		const { id } = req.params;
		if (!id) {
			return res.status(StatusCodes.FORBIDDEN).json({error: "Invalid request"})
...
export const deleteRFPController = async (req: Request, res: Response) => {
	try {
		const { id } = req.params;
		if (!id) {
			return res.status(StatusCodes.FORBIDDEN).json({error: "Invalid request"})
