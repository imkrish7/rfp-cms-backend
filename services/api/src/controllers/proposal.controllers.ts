...
export const scoreProposalController = async (req: Request, res: Response) => {
...
export const createPresignController = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
        if (!id) {
...
export const updateAttachmentStatusController = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
        if (!id) {
            return res.status(StatusCodes.FORBIDDEN).json({error: "Invalid request"})
...
export const proposalStatusUpdateController = async (req: Request, res: Response) => {
